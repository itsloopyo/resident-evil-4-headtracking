...
set "MOD_CONTROLS=Controls:&echo   End  - Toggle head tracking on/off&echo   PgUp - Toggle position tracking&echo   PgDn - Toggle world/camera-local yaw&echo   Ins  - Toggle reticle"
